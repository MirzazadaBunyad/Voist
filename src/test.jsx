...
function Test() {
  ...
  useEffect(() => {
    if (forgetPasswordVisible) {
      gsap.to(".active", { display: "block", duration: 0.5 });
    } else {
      gsap.to(".active", { display: "none", duration: 0.5 });
    }
    ("<");
  ...
  return (
    <section style={{ display: "flex" }}>
      <div className={styles.container}>
        <section>
          <header className={styles.logo} style={{ zIndex: 1 }}>
            {
              <svg
                width="91"
                height="26"
            ...
            <button onClick={openForgetPassword}>asdasd</button>
          </header>
          ...
          <main className="formContainer">
            ...
            >
              <div className="login" style={{ position: "relative" }}>
                <Login show={show} ChangeComponents={ChangeComponents} />
              </div>
            </CSSTransition>
